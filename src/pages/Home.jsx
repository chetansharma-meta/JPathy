  ...
  return (
    <>
      ...
      <div className="h-screen w-full">
        <div className="flex flex-col flex-wrap p-20 justify-center">
...
<div className="h-[37rem] sm:h-screen flex flex-col sm:flex-row">
  ...
  <div className="h-2/4 sm:h-full flex flex-col justify-center p-10 sm:px-20 bg-slate-500">
    <h1 className="text-[42px] sm:text-6xl text-black">
      DR.<span className="text-[#60cf80] font-bold">Devesh</span>Jangid
    </h1>
    <h2 className="text-[22px] sm:text-3xl text-black">
      A <span className="text-[#60cf80] font-bold">HomeoPath</span> who cares for you
    </h2>
    {/* Contact Button */}
